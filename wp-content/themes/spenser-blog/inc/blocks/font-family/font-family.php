...
add_action( 'wp_enqueue_scripts', 'spenser_blog_google_fonts_scripts' );
function spenser_blog_google_fonts_scripts() {
    $args = spenser_blog_used_google_fonts();
    wp_enqueue_style( 'google-fonts', spenser_blog_fonts_url( $args ), array(), null );
}