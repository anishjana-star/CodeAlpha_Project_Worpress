...
add_action( 'customize_register', 'spenser_blog_register_font_customization_section' );
function spenser_blog_register_font_customization_section( $wp_customize ) {

	$wp_customize->add_section( 'spenser_blog_font_customization_section', array(
	    'title'	=> esc_html__( 'Font Options', 'spenser-blog' ),
	    'priority'	=> 20
	) );
