...
add_action( 'customize_register', 'spenser_blog_color_section' );
function spenser_blog_color_section( $wp_customize )
{
    $wp_customize->get_section( 'colors' )->title = esc_html__( "Color Options", 'spenser-blog' );
