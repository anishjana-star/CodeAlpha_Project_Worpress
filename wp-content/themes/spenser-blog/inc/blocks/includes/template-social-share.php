<script type="text/javascript">
	var fb = '<?php echo esc_html__( "Facebook", 'spenser-blog' ); ?>';
	var twitter = '<?php echo esc_html__( "Twitter", 'spenser-blog' ); ?>';
	var pinterest = '<?php echo esc_html__( "Pinterest", 'spenser-blog' ); ?>';
	var linkedin = '<?php echo esc_html__( "Linkedin", 'spenser-blog' ); ?>';
</script>
...
<ul class="list-inline">
	...
	<li><?php esc_html_e( "Share", 'spenser-blog' ); ?>:</li>
