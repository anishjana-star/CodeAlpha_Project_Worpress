...
add_action( 'customize_register', 'spenser_blog_register_post_snippet_customization_section' );
function spenser_blog_register_post_snippet_customization_section( $wp_customize ) {

	$wp_customize->add_section( 'spenser_blog_post_snippet_customization_section', array(
	    'title'	=> esc_html__( 'Post Snippet', 'spenser-blog' ),
	    'priority'	=> 22
	) );
