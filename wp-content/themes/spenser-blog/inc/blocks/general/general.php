...
add_action( 'customize_register', 'spenser_blog_register_general_customization_section' );
function spenser_blog_register_general_customization_section( $wp_customize ) {

	$wp_customize->add_section( 'spenser_blog_general_customization_section', array(
	    'title'	=> esc_html__( 'General Options', 'spenser-blog' ),
	    'priority'	=> 21
	) );
